...
{
    case 'Clear':
    weather_image.src="/iimages/clear.png";
    break;
    case 'Clouds':
        weather_image.src="/iimages/cloud.png";
        break;
        case 'Mist':
            weather_image.src="/iimages/mist.png";
            break;
            case 'Rain':
                weather_image.src="/iimages/rain.png";
                break;
                case 'Snow':
                    weather_image.src="/iimages/snow.png";
                    break;
}
}
